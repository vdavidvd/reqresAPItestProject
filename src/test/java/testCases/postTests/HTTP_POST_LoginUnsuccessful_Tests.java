...
public class HTTP_POST_LoginUnsuccessful_Tests extends Base {
    ...
    public void validateStatusCode(){
        eTest = extentReport.createTest("POST_LoginUnsuccessful > validateStatusCode");
    ...
    public void validateStatusLine(){
        eTest = extentReport.createTest("POST_LoginUnsuccessful > validateStatusLine");
    ...
    public void validateResponseBody(){
        eTest = extentReport.createTest("POST_LoginUnsuccessful > validateResponseBody");

        Object responseMessage = response.body().jsonPath().get("error");

        if (responseMessage.equals("Missing password")){
            result = true;
            Assert.assertTrue(result);
    ...
    public void validateResponseTime(){
        eTest = extentReport.createTest("POST_LoginUnsuccessful > validateResponseTime");
    ...
    public void validateResponseHeaders(){
        eTest = extentReport.createTest("POST_LoginUnsuccessful > validateResponseHeaders");
